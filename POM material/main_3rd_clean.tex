...
\begin{figure}[ht!]
\centering
\includegraphics[width=17cm]{fig1_timeline_revised.pdf} 
...
\textcolor{blue}{We conduct numerical analyses on our assumptions on renter heterogeneity and report the technical details and results in Appendix C. Here, we summarize the main insights. First, we find that our findings remain consistent when we relax the assumption of bandwidth usage distribution. 
