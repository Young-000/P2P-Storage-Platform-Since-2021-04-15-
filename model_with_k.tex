...
1) subscription\\
\begin{equation*}
U_i &= K + \lambda_i u_i - \theta p_s \ge 0 
\end{equation*}
If $\theta p_s \le  K \rightarrow$ all users will use the platform. Then, $p_s = \frac{K}{\theta}$ will be an optimal solution. \\

2) two-part tariff \\ 
\begin{equation*}
U_i &= K + \lambda_i u_i - \theta p_s - \lambda_i p_b \ge 0
\end{equation*}
$\theta p_s \le K \rightarrow$
$n_r - n_r(1-\frac{2\theta p_s }{3\lambda_0} - p_b)$
