...
\noindent In this section, we first describe our model setups and players, which is followed by the key decisions of players. We present the summary of basic notations in Table \ref{tbl:summary}. The proofs of all lemmas and theorems are available upon request.\footnote{For transparency of the peer-review process, we can provide a separate supplementary material that includes all proofs and numerical analysis. Please reach out to the authors via the editors.}
...
\noindent The supplementary material for peer review can be provided upon request.
